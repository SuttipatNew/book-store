var menu = ['home', 'publisher', 'book', 'issue', 'ord_line', 'sub_agent', 'regular_cust', 'address', 'order_table', 'delivery', 'ord-on-day', 'ord-delivery', 'sa-receipt'];
...
var complex_page = ['ord-on-day', 'ord-delivery', 'sa-receipt'];
var command_map = {
    'ord-on-day' : 6,
    'ord-delivery' : 7
}
